  ...
  return (
    <div className="relative text-white ">
      ...
      <div className="relative z-10">
        <section className="flex flex-wrap items-center justify-between px-5 py-10 lg:py-16" data-aos="fade-up">
        ...
        <section id="features" className="py-10 lg:py-16" data-aos="fade-up">
        ...
        <section
          id="add-patient"
          className="flex flex-wrap items-center justify-between px-5 py-10 lg:py-16"
          data-aos="fade-up"
        >
        ...
        <section className="text-center py-10 lg:py-16" data-aos="fade-up">
        ...
        <section id="records" className="py-10 lg:py-16" data-aos="fade-up">
          <Image
